import grpc
import nativesdk_heipc_cpp_server_grpc_client.greeter_pb2 as greeter_pb2
import nativesdk_heipc_cpp_server_grpc_client.greeter_pb2_grpc as greeter_pb2_grpc
